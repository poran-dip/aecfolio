    ...
    data: {
      ...
      student: {
        create: {
          ...
          results: {
            create: [
              { semester: 1, sgpa: 8.5, verified: true, verifiedBy: faculty.id },
              { semester: 2, sgpa: 8.8, verified: true, verifiedBy: faculty.id },
              { semester: 3, sgpa: 8.6, verified: true, verifiedBy: faculty.id },
              { semester: 4, sgpa: 9.0, verified: true, verifiedBy: faculty.id },
