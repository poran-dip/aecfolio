...
export const metadata: Metadata = {
  title: "Sign In",
  description:
    "Sign in to AEC Profiles with your institutional Google account.",
};
      ...
      <div className="absolute inset-y-0 left-0 z-10 hidden lg:flex w-full max-w-2xl flex-col justify-between p-12 text-white">
        <div>
          <div className="flex items-center gap-4 mb-10">
            ...
            <div>
              <p className="font-bold text-3xl tracking-tight text-white drop-shadow-md">
                AEC Profiles
              </p>
              <p className="text-blue-200 font-medium text-lg mt-0.5">
        ...
        <div className="grid grid-cols-2 gap-5 mt-12 pb-8">
          {features.map((f) => (
            ...
            >
              <div className="text-blue-300 mb-3 bg-white/10 w-fit p-2 rounded-lg">
                {f.icon}
              </div>
      ...
      <div className="relative z-20 w-full max-w-md p-8 lg:p-10 mx-6 lg:mx-24 glass rounded-4xl shadow-2xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-slate-600 font-medium mt-2">
            Sign in with your{" "}
            <span className="text-blue-600 font-bold">@aec.ac.in</span> Google
            account to continue.
          </p>
        </div>
        ...
        <p className="text-center text-sm text-slate-500 font-medium mt-8 px-4 leading-relaxed">
          ...
          <span className="text-slate-700 font-bold">@aec.ac.in</span> accounts
          only.
          <br />
