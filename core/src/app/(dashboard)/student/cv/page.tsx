...
export default function GenCVPage() {
  ...
  return (
    <div className="flex flex-col h-full">
      <Navbar
        title="CV Generator"
        subtitle="Generate a department-branded PDF from your profile data"
        actions={
          <Button onClick={handleDownload} loading={generating} icon={<Download size={14} />}>
            Download PDF
          </Button>
        }
      />
      ...
      <div className="flex-1 flex flex-col md:flex-row bg-slate-100 overflow-hidden">
        ...
        <div className="w-full md:w-80 min-w-[320px] bg-white border-r border-slate-200 p-6 flex flex-col shrink-0 overflow-y-auto">
          ...
          <div className="space-y-6">
            ...
            <Card padding="sm" className="bg-slate-50 border-dashed border-slate-300">
              ...
              <p className="text-xs text-slate-500">
                Only your faculty-verified SGPA/CGPA will appear on your CV. If your CGPA isn't showing, verify your results in the Academic section.
              </p>
            </Card>
        ...
        <div className="flex-1 p-4 md:p-8 flex items-center justify-center bg-slate-200/50 shadow-[inset_0_2px_10px_rgba(0,0,0,0.02)] overflow-y-auto">
          ...
          <div className="w-full max-w-[800px] aspect-[1/1.4] bg-white shadow-xl rounded flex flex-col items-center justify-center text-center p-8 border border-slate-200 relative group overflow-hidden">
            ...
            <h3 className="text-xl font-semibold text-slate-700 mb-2">CV Preview Ready</h3>
            <p className="text-slate-500 max-w-sm mb-6">
              Your data will be instantly compiled into the official standard template. Information is pulled live from your profile.
            </p>
            <Button variant="outline" onClick={handleDownload} loading={generating}>
