  ...
  return (
    <div>
      <Navbar
        ...
        subtitle="System overview and placement analytics"
      />
      ...
      <div className="p-6 max-w-6xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <StatCard
            ...
            color="purple"
            trend="Overall College"
          />
          <StatCard
            label="Verified Results"
            value={stats.verifiedSgpas}
            icon={<CheckCircle size={22} />}
            color="green"
            trend="Total SGPA records locked"
          />
          <StatCard
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white rounded-xl border border-slate-200 p-6 shadow-sm">
            ...
            <p className="text-sm text-slate-500 mb-6">
              Build specific queries to find students matching company skill and
              CGPA criteria. Export the list to CSV or generate a batch CV zip.
            </p>
