...
export default function AdminQueryPage() {
  ...
  return (
    <div className="flex flex-col h-full bg-slate-50">
      <Navbar
        title="Placement Query Builder"
        subtitle="Filter students by CGPA, branch, and skills for recruitment drives"
      />
                      ...
                      <tr key={r.id} className="hover:bg-slate-50">
                        ...
                        <td className="px-6 py-4">
                          <div className="flex flex-wrap gap-1">
                            {r.skills.slice(0, 3).map((s) => (
                              <span
                                key={s}
                                className={`px-2 py-0.5 text-[10px] font-medium rounded-sm border ${skillFilter && s.toLowerCase().includes(skillFilter.toLowerCase()) ? "bg-amber-100 text-amber-800 border-amber-200" : "bg-slate-100 text-slate-600 border-slate-200"}`}
                              >
                                {s}
                              </span>
                            ))}
                        ...
                        <td className="px-6 py-4 text-right">
                          <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium bg-slate-100 text-slate-700 rounded-lg hover:bg-slate-200 transition"
                          >
