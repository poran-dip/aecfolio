...
export default function FacultyProfilePage() {
  ...
  return (
    <div>
      <Navbar title="Faculty Profile" subtitle="Your personal and professional details" />
      ...
      <div className="p-6 space-y-6 max-w-4xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row gap-6 items-center md:items-start p-6 bg-white border border-slate-200 rounded-xl shadow-sm relative overflow-hidden">
          ...
          <div className="relative mt-8 md:mt-8 flex flex-col md:flex-row items-center md:items-end gap-6 w-full">
            ...
            <div className="flex-1 text-center md:text-left pb-1">
              ...
              <p className="text-slate-500 font-medium mt-1">{data.designation} • {data.department}</p>
              <div className="flex items-center justify-center md:justify-start gap-4 mt-4">
                <span className="text-xs px-3 py-1 bg-emerald-100 text-emerald-700 font-bold rounded-full tracking-wide uppercase">Faculty Member</span>
        ...
        {/* Details Card */}
        <Card>
          <CardHeader title="Professional Details" icon={<User size={18} />} description="Read-only view of your registered information" />
